...
$$\frac{1}{{n - 1}}\left( {\sum\limits_{i = 1}^n {x_i^2}-\frac{{{{\left( {\sum\limits_{i = 1}^n {{x_i}} } \right)}^2}}}{n}} \right)$$     

$${\sigma ^2} = \frac{1}{N}\sum\limits_{i = 1}^N {({x_i} - \mu } {)^2} = $$
$$\frac{1}{N}\left( {\sum\limits_{i = 1}^N {x_i^2}  - \frac{{{{\left( {\sum\limits_{i = 1}^N {{x_i}} } \right)}^2}}}{N}} \right)$$    
